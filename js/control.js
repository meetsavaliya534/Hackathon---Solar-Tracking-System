...
function loadContent(query) {
  ...
  //document.title = currentChap["content-title"];
  ...
  //set quiz
  if (currentChap.quiz) $("#below-app .quiz").attr("href", currentChap.quiz);
  else $("#below-app .quiz").addClass("hidden");
  //set next
  if (currentChap.next) $("#below-app .next").attr("href", currentChap.next);
  else $("#below-app .next").addClass("hidden");
  //set certificate
  if (currentChap.certificate) $("#below-app .certificate").attr("href", currentChap.certificate);
  else $("#below-app .certificate").addClass("hidden");
